 ...
 const validate = () => {
  ...
  if(patientDetails.Patient_Phno && !/^\d{10}$/.test(patientDetails.Patient_mobile)){
...
// //    try {
// //      const editFlag = isEditMode ? 1 : 0;
// //      console.log('Saving/updating patient details with data:', {
// //        ...patientDetails,
// //        Patient_CpyId: 2,
// //        Patient_YrId: 2425,
// //        EditFlag: editFlag,
...
// //        } else {
// //          setIsEditMode(false); // Set to view mode after updating
// //       }
// //      } else {
// //        toast.error('Failed to save/update patient details');
// //      }
...
// //  };
    ...
    <Grid item xs={12} sm={2}>                     <FormControl fullWidth variant="outlined" sx={{ width: '100%', height: '100%' }}>
                   ...
                   <Grid item xs={12} sm={7}>
                    <TextField
                       id="name"
                       label="Name"
                       variant="outlined"                       value={patientDetails.Patient_Name}
                 ...
                 <Grid item xs={12} sm={1}>
                    ...
                    </Grid>                     <Grid item container xs={12} sm={7} spacing={1}>
                       <Grid item xs={3}>
                        <TextField
                         id="dd"
                          ...
                          size="small"
                          fullWidth
                         value={patientDetails.Patient_Agedd}                         onChange={(e) => setPatientDetails({ ...patientDetails, Patient_Agedd: e.target.value })}
                           InputLabelProps={{ style: { fontSize: '14px' } }}
                           disabled={!isEditMode} 
                         />
                       </Grid>
